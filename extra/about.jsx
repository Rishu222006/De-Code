        ...
        <div className="min-h-screen bg-gradient-to-br from-black via-[#0b0f14] to-black text-white px-6 py-20">
            ...
            <section className="max-w-5xl mx-auto text-center mb-20">
                <h1 className="text-4xl md:text-5xl font-bold mb-6">
                    About <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-700 via-slate-500 to-slate-200">
                        De-CODE
                    </span>
                </h1>
            ...
            <section className="max-w-6xl mx-auto mb-24">
                <h2 className="text-3xl font-bold text-center mb-12">
                    Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-700 via-slate-500 to-slate-200">
                        De-CODE
                    </span>?
                </h2>
